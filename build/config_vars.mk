...
OS = unix
OS_DIR = unix
BUILTIN_LIBS = modules/aaa/libmod_authn_file.la modules/aaa/libmod_authn_default.la modules/aaa/libmod_authz_host.la modules/aaa/libmod_authz_groupfile.la modules/aaa/libmod_authz_user.la modules/aaa/libmod_authz_default.la modules/aaa/libmod_auth_basic.la modules/cache/libmod_file_cache.la modules/cache/libmod_cache.la modules/cache/libmod_disk_cache.la modules/cache/libmod_mem_cache.la modules/filters/libmod_include.la modules/filters/libmod_filter.la modules/filters/libmod_deflate.la modules/loggers/libmod_log_config.la modules/metadata/libmod_env.la modules/metadata/libmod_headers.la modules/metadata/libmod_setenvif.la modules/metadata/libmod_version.la modules/proxy/libmod_proxy.la modules/proxy/libmod_proxy_connect.la modules/proxy/libmod_proxy_ftp.la modules/proxy/libmod_proxy_http.la modules/proxy/libmod_proxy_scgi.la modules/proxy/libmod_proxy_ajp.la modules/proxy/libmod_proxy_balancer.la modules/http/libmod_http.la modules/http/libmod_mime.la modules/generators/libmod_status.la modules/generators/libmod_autoindex.la modules/generators/libmod_asis.la modules/generators/libmod_cgi.la modules/mappers/libmod_negotiation.la modules/mappers/libmod_dir.la modules/mappers/libmod_actions.la modules/mappers/libmod_userdir.la modules/mappers/libmod_alias.la modules/mappers/libmod_so.la
SHLIBPATH_VAR = LD_LIBRARY_PATH
OS_SPECIFIC_VARS =
PRE_SHARED_CMDS = echo ""
POST_SHARED_CMDS = echo ""
shared_build =
AP_LIBS = /home/zhongyj/httpd-2.2.24/srclib/pcre/libpcre.la /home/zhongyj/httpd-2.2.24/srclib/apr-util/libaprutil-1.la -lexpat /home/zhongyj/httpd-2.2.24/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/zhongyj/httpd-2.2.24
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/zhongyj/httpd-2.2.24/srclib/apr/include -I/home/zhongyj/httpd-2.2.24/srclib/apr-util/include -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/zhongyj/httpd-2.2.24/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
MODULE_DIRS = aaa cache filters loggers metadata proxy http generators mappers
MODULE_CLEANDIRS = arch/win32 database debug echo experimental ldap ssl test dav/main dav/fs dav/lock
PORT = 80
SSLPORT = 443
...
APR_INCLUDEDIR = /home/zhongyj/httpd-2.2.24/srclib/apr/include
APR_VERSION = 1.4.6
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/zhongyj/httpd-2.2.24/srclib/apr-util/include
APU_VERSION = 1.4.1
